...
import bgimage from './components/NewsCell/avatar.jpeg';
    ...
    <div className="app">
      ...
      <main>
        ...
        <Button
          ...
          setVisible={setFormIsVisible}
        >
          <span className="icon_add" aria-hidden="true">
            <svg width="13" height="13">
              <path
                d="M6 6V.5a.5.5 0 0 1 1 0V6h5.5a.5.5 0 1 1 0 1H7v5.5a.5.5 
              0 1 1-1 0V7H.5a.5.5 0 0 1 0-1H6z"
                fill="currentColor"
              ></path>
            </svg>
          </span>
        ...
        <div className="container">
          <div className="row g-2">
            <div className="col-md-6">
              <NewsCell link={'https://test.test'} title={'В МВД рассказали о сроках и плюсах добровольной сдачи нелегального арсенала'} date={'Вчера, 21:34'} views={0} background={bgimage}/>
            </div>
            <div className="col-md-6">
              <div className="row g-2">
