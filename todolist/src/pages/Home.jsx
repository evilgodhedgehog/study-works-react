...
import bgimage from '../components/PostCell/avatar.jpeg';
import SocialShareWindow from "../components/PostCell/SocialShareWindow";
            ...
            <main>
                ...
                <section className="section-main pt__3">
                    ...
                    <div className="col-md-5">
                        <PostCell handleToggle={handleToggle} link={'https://test.test'} title={'В МВД рассказали о сроках и плюсах добровольной сдачи нелегального арсенала'} date={'Вчера, 21:34'} views={10} background={bgimage}/>
                    </div>
                    <div className="col-md-3">
                        <PostList handleToggle={handleToggle} posts={news}/>
                    </div>
