...
const TaskForm = ({create, visible, setVisible}) => {
    ...
    const classes = [cl.addTaskForm];

    if(visible){
      classes.push(cl.show)
    }

    const invisibleForm = (e) => {
      e.preventDefault();
      setVisible(false);
    }
    ...
    return (
      <form className={classes.join(' ')}>
        ...
        <Button onClick={invisibleForm}>Отмена</Button>  
      </form>
    );
};
